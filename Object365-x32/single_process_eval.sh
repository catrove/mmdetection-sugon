...
APP="python3 -u ../tools/eval.py --config gloo_eval_32x4_centripetalnet_mask_hg104.py --load_from ./work_dirs/gloo_32x4_centripetalnet_mask_hg104/epoch_26_iter_54499.pth --dist_url tcp://${1}:42367 --world_size=${comm_size} --rank=${comm_rank} --launcher=gloo "
case ${lrank} in
[0])
