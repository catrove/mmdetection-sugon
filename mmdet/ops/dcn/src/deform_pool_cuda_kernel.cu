                                ...
                                const float trans_std)
{
  ...
  AT_DISPATCH_FLOATING_TYPES(
      data.scalar_type(), "deformable_psroi_pool_forward", ([&] {
        ...
        hipLaunchKernelGGL(DeformablePSROIPoolForwardKernel, dim3(GET_BLOCKS(count)), dim3(CUDA_NUM_THREADS), 0, at::hip::getCurrentHIPStream(), 
                                    ...
                                    const float trans_std)
{
  ...
  AT_DISPATCH_FLOATING_TYPES(
      out_grad.scalar_type(), "deformable_psroi_pool_backward_acc", ([&] {
        ...
        hipLaunchKernelGGL(DeformablePSROIPoolBackwardAccKernel, dim3(GET_BLOCKS(count)), dim3(CUDA_NUM_THREADS), 0, at::hip::getCurrentHIPStream(), 
