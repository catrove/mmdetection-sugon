...
APP="python3 -u ./tools/eval.py --config gloo_centripetalnet_hg104.py --load_from work_dirs/gloo_centripetalnet_mask_hg104/latest.pth --dist_url tcp://${1}:42367 --world_size=${comm_size} --rank=${comm_rank} --launcher=gloo "
case ${lrank} in
[0])
